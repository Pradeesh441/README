...
General calendar view, On selecting a day, the schedules for that day, To-Do’s and Notes created on that day will be displayed, Navigating to the schedule or To-Do or Notes from the list, Creating a schedule, View the list of schedules, To-Do’s and Notes of particular Day, Week, Month, and Send notification of events.
